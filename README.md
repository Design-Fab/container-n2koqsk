...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n2koqsk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n2koqsk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Design-Fab/container-n2koqsk.git
cd container-n2koqsk
```
...
```
docker attach container-n2koqsk
```
